...
public class WashDryFold extends AppCompatActivity {
    ...
    private final int fold15KgPrice = 10;
    private final int fold20KgPrice = 20;
    private final int fold30KgPrice = 30;

    private TextView totalLaundryText;

    private TextView textwasher, textdryer, textfold;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set up click listeners for fold options
        RelativeLayout fold15KgLayout = findViewById(R.id.layout7);
        fold15KgLayout.setOnClickListener(v -> {
            selectedFoldPrice = fold15KgPrice;
            textfold.setText("Fold: 15 KG (RM 10)");
            calculateTotal();
        });

        RelativeLayout fold20KgLayout = findViewById(R.id.layout8);
        fold20KgLayout.setOnClickListener(v -> {
            selectedFoldPrice = fold20KgPrice;
            textfold.setText("Fold: 20 KG (RM 20)");
            calculateTotal();
        });

        RelativeLayout fold30KgLayout = findViewById(R.id.layout9);
        fold30KgLayout.setOnClickListener(v -> {
            selectedFoldPrice = fold30KgPrice;
            textfold.setText("Fold: 30 KG (RM 30)");
            calculateTotal();
        });
    }

    private void calculateTotal() {
        int total = selectedWasherPrice + selectedDryerPrice + selectedFoldPrice;
        ...
        imgaddtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String foldOption = textfold.getText().toString();
        ...
        checkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String dryerOption = textdryer.getText().toString();
                String foldOption = textfold.getText().toString();
                int totalAmount = selectedWasherPrice + selectedDryerPrice + selectedFoldPrice;
