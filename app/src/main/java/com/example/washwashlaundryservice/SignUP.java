...
public class SignUP extends AppCompatActivity {
    ...
    private EditText nameUser, emailUser, pwdUser, cpwdUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pwdUser = findViewById(R.id.pwdUser);
        cpwdUser = findViewById(R.id.cpwdUser);
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(nameUser1)) {
                    ...
                    registerUser(nameUser1, emailUser1, pwdUser1);
                }
            }
        });
    }

    private void registerUser(String nameUser1, String emailUser1, String pwdUser1) {
        ...
        auth.createUserWithEmailAndPassword(emailUser1, pwdUser1).addOnCompleteListener(SignUP.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    SignClass classRef = new SignClass(userID, nameUser1, emailUser1, pwdUser1, roleUser);
                    ...
                    try{
                        ...
                        emailUser.setError("User is already registered with this email. Use another email.");
                        emailUser.requestFocus();
                    } catch (Exception e){
